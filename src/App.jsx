    ...
    <>
      ...
      <main style={{ maxWidth:1100, margin:"0 auto", padding:"0 24px" }}>
        ...
        {tab === "inicio" && (
          <div className="fu">
            {/* Hero full-width */}
            <div style={{ background:HERO, borderRadius:0, padding:"64px 48px 56px", color:C.white, position:"relative", overflow:"hidden", marginBottom:40, width:"100vw", left:"50%", transform:"translateX(-50%)" }}>
              <Particles />
